...
ActiveRecord::Schema.define(version: 2021_05_19_021358) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["commenter_id", "video_id"], name: "index_comments_on_commenter_id_and_video_id"
  end
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["liker_id", "video_id"], name: "index_likes_on_liker_id_and_video_id"
